                ...
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                    <div class="row content-header">
                        <div class="mylabel3 col-sm-6">
                            <h4><a id="fejszoveg"> {{ langClass::trans('Log adatok') }}</a></h4>
                        </div>
                        <div class="mylabel3 col-sm-6">
...
{{--                            <a href="#" class="btn btn-primary szuresgomb mind" title="Minden tétel"><i class="fas fa-eraser"></i></a>--}}
                        ...
                        <div class="col-sm-4">
                            {!! Form::label('customer', langClass::trans('Partner:')) !!}
                        ...
                        <div class="col-sm-4">
                            {!! Form::label('felhasznalo', langClass::trans('Felhasználó:')) !!}
                        ...
                        <div class="col-sm-2">
                            {!! Form::label('startDate', langClass::trans('Időszak tól:')) !!}
                        ...
                        <div class="col-sm-2">
                            {!! Form::label('endDate', langClass::trans('ig:')) !!}
        ...
        $(function () {
            ...
            var table = $('.partners-table').DataTable({
                ...
                ajax: "{{ route('indexBetween', [ empty($_COOKIE['logStartDate']) ? date('Y-m-d', strtotime('now - 1 day')) : $_COOKIE['logStartDate'],
                                                 ...
                                                 myUser::user()->id]) }}",
                columns: [
                    {title: <?php echo "'" . langClass::trans('Feladat') . "'"; ?>, data: 'action', sClass: "text-center", width: '150px', name: 'action', orderable: false, searchable: false},
                    {title: <?php echo "'" . langClass::trans('Partner cég') . "'"; ?>, data: 'customerName', name: 'customerName'},
                    {title: <?php echo "'" . langClass::trans('Felhasználó') . "'"; ?>, data: 'userName', name: 'userName'},
                    {title: <?php echo "'" . langClass::trans('Dátum') . "'"; ?>, data: 'eventdatetime', render: function (data, type, row) { return data ? moment(data).format('YYYY.MM.DD HH:mm:ss') : ''; }, sClass: "text-center", width:'150px', name: 'eventdatetime'},
                    {title: <?php echo "'" . langClass::trans('Esemény') . "'"; ?>, data: 'eventName', sClass: "text-center", name: 'eventName'},
                ]
            });
            ...
            $('.egynap').click(function () {
                ...
                $('#fejszoveg').text(<?php echo "'" . langClass::trans('Log adatok elmúlt 24 óra') . "'"; ?>);
